...
export API_HOST=${API_HOST:="https://api.qa.community.eblanetwork.com"}
export API_CLAIM_HOST=${API_CLAIM_HOST:="https://api.qa.claim.eblanetwork.com"}
export API_EBLA_HOST=${API_EBLA_HOST:="https://api.eblanetwork.com"}
...
export DELEGATION_API_HOST=${DELEGATION_API_HOST:="https://api-delegation.qa.community.eblanetwork.com"}
...
find $STATIC_FOLDER -type f -exec sed -i "s,REACT_APP_API_EBLA_HOST_STRING_REPLACE,$API_EBLA_HOST,g" {} \;
